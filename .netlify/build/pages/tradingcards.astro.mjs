...
const $$Tradingcards = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Layout2", $$Layout2, {}, { "default": async ($$result3) => renderTemplate` ${maybeRenderHead()}<div style="background:rgba(255,255,255,0.8)" class="flex flex-col gap-2 w-screen py-20 px-5 sm:px-40"> ${renderComponent($$result3, "Title", $$Title, { "title": "Trading Cards" })} ${splitImages(tradingcards).map((arr, index) => renderTemplate`${renderComponent($$result3, "Rows", $$Rows, { "images": arr, "key": index })}`)} </div> ` })} ` })}`;
}, "C:/Users/CodecD/Desktop/Website Projects/Adam_Portfolio/frontend/src/pages/tradingcards.astro", void 0);

const $$file = "C:/Users/CodecD/Desktop/Website Projects/Adam_Portfolio/frontend/src/pages/tradingcards.astro";
const $$url = "/tradingcards";
